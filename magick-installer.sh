...
download https://ftp.osuosl.org/pub/blfs/conglomeration/tiff/tiff-3.9.4.tar.gz
...
download https://launchpad.net/imagemagick/main/6.6.7-0/+download/ImageMagick-6.6.7-0.tar.gz
